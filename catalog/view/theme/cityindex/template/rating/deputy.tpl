            ...
            <div class="container-fluid container-custom">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                         <h2 class="module-title font-alt">  Рейтинг заметности депутатов Мосгордумы</h2>
                        <p class="module-subtitle">Исследовательский центр Cityindex подготовил рейтинг заметности депутатов Мосгордумы на основе упоминаний в социальных медиа за февраль 2016 года. 
